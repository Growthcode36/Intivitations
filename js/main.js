...
const scrollSpeed = 20;  // Adjust this value for faster/slower scrolling

function autoScroll() {
  window.scrollBy(0, 1); // Scroll the page 1px down every time
}

// Start auto-scrolling with the defined speed
setInterval(autoScroll, scrollSpeed);
// JavaScript for Auto-Scrolling end
...
document.getElementById("nama").innerHTML = to ? decodeURI(to) : "test";
